...
namespace True;
/**
 * Clean is a class with methods for cleaning all kinds of data that a website might encounter. This is the non-static version you can instantiate in the $App container.
 *
...
class Clean
{
	...
	public function filterOutURLs($str) 
	{
		if (is_null($str))
			return '';
	...
	public function forMetaTags($str)
	{
		$find = array('"',"'"," & ");
		$replace = array('','',' &amp; ');
	...
	public function forHtmlEditors($str)
	{
		return str_replace("&",'&amp;',$str);
	}
	
	public function htmlOutput($str)
	{
		$find = array(" & ");
		$replace = array(' &amp; ');
	...
	public function sanitize($str, $santype = 1)
	{
